                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildScreenTitle(
                          context,
                          screenTitle: "Maps One",
                          onTapScreenTitle: () => onTapScreenTitle(
                              context, AppRoutes.mapsOneScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "Password Change",
                          onTapScreenTitle: () => onTapScreenTitle(
                              context, AppRoutes.passwordChangeScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "Email Change",
                          onTapScreenTitle: () => onTapScreenTitle(
                              context, AppRoutes.emailChangeScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "Material - Tab Container",
                          onTapScreenTitle: () => onTapScreenTitle(
                              context, AppRoutes.materialTabContainerScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "Cart",
